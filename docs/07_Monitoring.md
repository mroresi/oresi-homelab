...
- 🌎 Be accessible via Tailscale MagicDNS (e.g., kuma.whitebox.ts.net).  
...
─────────────────────────────────────────────────────────────
        ...
        Dash Access:
        • http://kuma.whitebox.ts.net:3001
        • http://netdata.redbox.ts.net:19999
─────────────────────────────────────────────────────────────
```
...
| Type | Target | Notes |
|------|---------|-------|
| HTTP | http://radarr.redbox.ts.net:7878 | Radarr availability |
